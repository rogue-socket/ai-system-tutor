"""Shared benchmark — IDENTICAL to Loop 7a's benchmark.py.

Do NOT modify this file. The whole point of the shared benchmark is that
Loop 7b's multi-agent results are directly comparable to Loop 7a's
single-agent results.

Loop 9 will extend the eval discipline (LLM-as-judge layer). Wait for that.
"""
import re
import time
